...
Update_Status ModuleInput::PreUpdate()
{
	...
	if (P1.buttons[SDL_CONTROLLER_BUTTON_A] != KEY_IDLE)			keys[SDL_SCANCODE_C] = P1.buttons[SDL_CONTROLLER_BUTTON_A];
	if (P1.buttons[SDL_CONTROLLER_BUTTON_B] != KEY_IDLE)			keys[SDL_SCANCODE_V] = P1.buttons[SDL_CONTROLLER_BUTTON_B];
